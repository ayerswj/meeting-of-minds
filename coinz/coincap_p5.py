# Store Cryptocurrency Information Project
#
...
# Constants used as counters to increment
start = 1
f = 1

# Create a xlsx file and wirte to it
...
# For 10 times grab cryptocurrencies from coinmarketcap
for i in range(10):
    ...
    # Loop through each data item returned
    for currency in data:
        # Store a data item in variables
        rank = currency['rank']
        name = currency['name']
        ...
        # Write those variables to the xlsx file
